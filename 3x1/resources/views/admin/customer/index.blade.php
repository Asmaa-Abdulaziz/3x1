            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-sm pull-right m-b-0 ml-2" href="{{ url('admin/customers/export') }}" role="button"><i class="fa fa-file-excel-o"></i>&nbsp; {{ trans('admin.customer.actions.export') }}</a>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'first_name'">{{ trans('admin.customer.columns.first_name') }}</th>
                                        <th is='sortable' :column="'last_name'">{{ trans('admin.customer.columns.last_name') }}</th>
                                        ...
                                        <th is='sortable' :column="'activated'">{{ trans('admin.customer.columns.activated') }}</th>
                                        <th is='sortable' :column="'forbidden'">{{ trans('admin.customer.columns.forbidden') }}</th>
